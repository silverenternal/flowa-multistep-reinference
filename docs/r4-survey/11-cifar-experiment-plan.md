...
The contents below were originally in
`12-cifar-experiment-instructions.md` (now merged into this section as
the user-facing checklist). Companion design doc references at the top
of the file still apply; the run commands, smoke-test snippets, and
expected output table are reproduced verbatim from the original
checklist.

**Date:** 2026-08-30
**Companion design doc:** `docs/r4-survey/11-cifar-experiment-plan.md` (this file)
**Script:** `tools/run_sota_cifar_experiment.py`
...
modes are in the companion design doc above.
...
- A regression > +10% must be reported honestly; check failure modes in
  the main plan body above (companion design doc).
