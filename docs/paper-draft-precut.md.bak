...
bearing in the framework (Bonferroni-corrected paired-t p = 1.11e-44 on
the L2 axis and p = 3.96e-31 on the entropy axis for kanzi n=30;
Bonferroni-corrected p = 0.00146 on the entropy axis for lineageflow
n=30 — Wave 193 P4 stats-recompute fix; the original "p < 1e-4" was
a coarse upper-bound shorthand for the kanzi axes), but the load-bearing
**manifestation** is axis- and
