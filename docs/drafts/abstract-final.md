# Abstract — Final (Wave 232 P2 + Wave 233 P7)

**Status.** Finalised after Wave 232 P2 TPAMI-envelope trim (250 words, 9
sentences) and Wave 233 P7 tier-aware-scheduler sentence (1 added;
body now 10 sentences). Body trimmed from 465 → 250 words via
Wave 232 P2; Wave 233 P7 adds 1 sentence (~28 words) on
`tier-aware scheduling` improvement (R6 d_z +0.0707 → +0.2235;
R2 sign flip), reflecting Wave 233 P3 counterfactual work. All
...
| Sentence 9 | 27 | **Tier-aware scheduler** (Wave 233 P3+P7): `TierAwareCodimensionSheetScheduler` lifts R6 d_z +0.071 → +0.223 (Δd_z=+0.152) and reverses R2 sign to +0.046, halving easy-tier regression |
| Sentence 10 | 27 | **Positioning** (Wave 207 S4): structural disjointness, SHA-256 + hash-chained + D.4 |
| — | **~275 words** | Wave 232 P2 trim + Wave 233 P7 tier-aware addition |
