...
folded into S10, and Wave 235 P5 final integration (P1-P4 top-4
...
disclosure). Body trimmed from 465 → 250 words via Wave 232 P2;
...
All key claims preserved (training-free + solver-agnostic re-inference
...
Wave 235 P1-P4 top-4 improvements).
...
| Sentence 10 | 33 | **Positioning** (Wave 207 S4 + Wave 235 P1 closing): structural disjointness, SHA-256 + hash-chained + D.4; Wave 235 P1 single-round n_rounds=1 structurally eliminates the R5b regression |
| — | **~328 words** | Wave 232 P2 trim + Wave 233 P7 tier-aware + Wave 234 P5 stats + Wave 235 P1-P4 top-4 improvements |

Note: The Wave 235 P5 final integration extends the abstract beyond the
TPAMI 250-word envelope by approximately 78 words. The body is 11
sentences (added 1 sentence on Wave 235 P3 R6 LARGE uplift + Wave 235
P2 R2 medium uplift); the Wave 235 P1 single-round R5b structural
elimination is folded into the validation sentence (S7) and the
non-inferiority closing of S10. The expansion prioritises the four
Wave 235 P1-P4 improvements (R5b fix, R2 medium uplift, R6 LARGE uplift,
FlowMol3 partial-sweep disclosure) which together close the load-bearing
