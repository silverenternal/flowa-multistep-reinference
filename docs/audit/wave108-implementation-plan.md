...
- `/home/hugo/codes/flowa-multistep-reinference/tools/kanzi_latent_to_coord.py:72-238` (bridge function — line 165 `torch.manual_seed`, line 229 `decoder.decode` call)
- `/home/hugo/codes/flowa-multistep-reinference/tools/sweep_kanzi_n1000_paper_metrics.py:32-37` (argparser), `:77` (`seed=0` call site)
- `/home/hugo/codes/flowa-multistep-reinference/tools/sweep_kanzi_n1000_framework_paper_metrics.py` (mirror of baseline driver)
- `/home/hugo/codes/flowa-multistep-reinference/tools/sweep_kanzi_n1000_framework_paper_metrics_inv_proj.py` (Wave 95.P3.C fix driver)
- `/home/hugo/codes/flowa-multistep-reinference/tools/_kanzi_sweep_runner.py` (Wave 105 P1-A shared sweep loop body)
- `/home/hugo/codes/flowa-multistep-reinference/tools/upstream_eval.py:173-388` (`run_lineageflow_upstream_eval` Wave 81 wrapper), `:99-101` (`LINEAGEFLOW_EVALUATE_ALL` path constant), `:262-283` (subprocess cmd builder), `:949-966` (CLI surface)
- `/home/hugo/codes/flowa-multistep-reinference/tools/gen_lineageflow_n1000_fastas.py:1-200` (Wave 86 FASTA generator — FASTAs already on disk)
- `/home/hugo/codes/flowa-multistep-reinference/tools/run_lineageflow_n1000_foldability_omegafold.py:1-200` (Wave 84 foldability + self_consistency wrapper)
- `/home/hugo/codes/flowa-multistep-reinference/tools/run_real_ckpt_eval.py` (eval CLI; `--model lineageflow --force-mode real --composite-metric real` Wave 47 wiring)
- `/home/hugo/codes/flowa-multistep-reinference/tools/_gpu_watchdog.py:1-250` (`gpu_watchdog` context manager + `gpu_status` one-shot poll)
- `/home/hugo/codes/flowa-multistep-reinference/tools/_sweep_assertion.py:1-200` (`assert_n_records_match` + `assert_n_records_match_with_file_count` + `write_summary_with_n_keys`)
- `/home/hugo/codes/flowa-multistep-reinference/tools/wave87_n1000_sweep.py:184-251` (`_generate_arm`), `:249-250` (`errors_sample: errors[:5]` + `n_errors: int(len(errors))`)
- `/home/hugo/codes/flowa-multistep-reinference/tools/eval/cli.py:29-200` (argparser — `run_real_ckpt_eval.py` CLI)
- `/home/hugo/codes/flowa-multistep-reinference/tools/eval/sweep.py` + `tools/eval/metrics.py` (per-cell sweep orchestrator + composite + real-metric helpers)
- `/home/hugo/codes/flowa-multistep-reinference/adaptive_reflow/adapters/kanzi.py:2098-2235` (`solve_ode` custom NumPy Euler/Heun — NOT a `DAE.decode` wrapper)
- `/home/hugo/codes/flowa-multistep-reinference/adaptive_reflow/adapters/flowmol3_v2_adapter.py:4541-4549` (caller of `sampled_mols_from_smiles`)
- `/home/hugo/codes/flowa-multistep-reinference/adaptive_reflow/adapters/flowmol3_metrics_upstream.py:205-254` (`sampled_mols_from_smiles` — drop point + warning hooks at line 232, 240)

### External vendored repos (audited)

- `/home/hugo/codes/flowa-multistep-reinference/data/kanzi_upstream/src/kanzi/models.py:364-372` (DAE.decode signature — NO seed param), `:375` (`x_BLD = torch.randn(...)`), `:421` (`eps = torch.randn_like(x_BLD)`), `:608` (RnFlowMatcher.sample — pure ODE), `:635-664` (euler_maruyama_sample), `:1137` (train-side seed in train_cb.py:220)
- `/home/hugo/codes/flowa-multistep-reinference/data/kanzi_upstream/src/kanzi/cfm.py:41, 98, 150, 153` (sample_noise_like — global RNG)
- `/home/hugo/codes/flowa-multistep-reinference/data/kanzi_upstream/src/kanzi/fsq.py:96` (jitter noise — global RNG)
- `/home/hugo/codes/flowa-multistep-reinference/data/kanzi_upstream/src/kanzi/train_cb.py:220` (train-side seed)
- `/home/hugo/codes/flowa-multistep-reinference/data/FlowMol3/repo/flowmol/models/flowmol.py:490-493` (FlowMol.sample signature — NO `return_errors` / `skip_errors` param), `:591-598` (SampledMolecule construction)
- `/home/hugo/codes/flowa-multistep-reinference/data/FlowMol3/repo/flowmol/analysis/molecule_builder.py` (SampledMolecule — also drops invalid mols silently)
- `/home/hugo/codes/flowa-multistep-reinference/data/lineageflow_upstream/evaluation/evaluate_all.py` (~400 LOC vendored orchestrator)
- `/home/hugo/codes/flowa-multistep-reinference/data/lineageflow_upstream/evaluation/run_foldability.py` + `foldability_omegafold.py` + `self_consistency_esmif.py` + `family_validity_hmmer.py` + `novelty_mmseqs2.py` (4 vendored metric scripts)
- `/home/hugo/codes/flowa-multistep-reinference/data/lineageflow_n1000/{baseline,framework}.fasta` (Wave 86 pre-generated, 1000 records each)
- `/home/hugo/codes/flowa-multistep-reinference/data/lineageflow_n1000/manifest.json` (per-record seed/family metadata)

### Pre-existing on-disk data (REUSE)

- `/home/hugo/codes/flowa-multistep-reinference/verification_outputs/flowmol3_n1000_baseline_q4_2026.json:5` (`n_sampled=999`, `n_smiles=1000`, `n_errors=0`)
- `/home/hugo/codes/flowa-multistep-reinference/verification_outputs/flowmol3_n1000_framework_q4_2026.json:5` (`n_sampled=1000`)
- `/home/hugo/codes/flowa-multistep-reinference/verification_outputs/lineageflow_n1000_baseline_q4_2026.json` (Wave 81 partial — 1 cell of N=1000)
- `/home/hugo/codes/flowa-multistep-reinference/verification_outputs/lineageflow_n1000_framework_q4_2026.json` (Wave 81 partial)
- `/home/hugo/codes/flowa-multistep-reinference/verification_outputs/lineageflow_v2_aggregated_q4_2026.json` (Wave 69 9-cell NFE-scan aggregated)
- `/home/hugo/codes/flowa-multistep-reinference/verification_outputs/ckpt_sha256.json` (Wave 106.C.1 — Kanzi + LineageFlow + FlowMol3 SHAs pinned)

### Venv configuration

- `/home/hugo/codes/flowa-multistep-reinference/.venvs/lineageflow_venv/pyvenv.cfg` (Python 3.12.13 + torch 2.7.0+cu128 — Wave 69 Agent 4 CUDA upgrade)
- `/home/hugo/codes/flowa-multistep-reinference/.venvs/kanzi_venv/` (Python 3.12 + torch CPU + diffusers + esm + biopython — Wave 39 Agent A sidecar)
- `/home/hugo/codes/flowa-multistep-reinference/.venvs/omegafold_venv/` (Python 3.10 sidecar — Wave 84 install for OmegaFold)

### Paper-package docs (for Commit 4-8 drops)

- `/home/hugo/codes/flowa-multistep-reinference/cover_letter.md:11, 19, 21, 29, 31, 39` (TL;DR + G1 SHA + G2 config + Honest limitations + Wave 99 update + Reproducibility)
- `/home/hugo/codes/flowa-multistep-reinference/submission_checklist.md:55, 63` (D.4 + ckpt_sha256 references)
- `/home/hugo/codes/flowa-multistep-reinference/supplementary.md:163, 248, 252` (§S3.5 FSQ noise floor + §S6.2 ckpt_sha256 + §S5.4 F-02 caveat)
- `/home/hugo/codes/flowa-multistep-reinference/docs/paper-draft.md:1275, 1942, 2115, 2169, 2321, 2609, 3192, 3241-3243` (§7.3/§7.4/§7.5/§7.6 + Wave 79/88/87/106 prose anchors)
- `/home/hugo/codes/flowa-multistep-reinference/docs/push-ready-summary.md:270, 1068-1070, 1375` (Wave 93/82/87 + Honest caveats anchors)
- `/home/hugo/codes/flowa-multistep-reinference/docs/CONSOLIDATED_RESULTS.md:2902` (`|Δ| < 1pp noise floor` tier)
- `/home/hugo/codes/flowa-multistep-reinference/docs/baseline-audit-report.md:482-611` (§C.7 SBC template + `pass_label` enum + seed_offset rationale at line 521)
- `/home/hugo/codes/flowa-multistep-reinference/docs/GATES.md` (canonical gate definitions — for D.4 disambiguation in Commit 7)
- `/home/hugo/codes/flowa-multistep-reinference/docs/audit/wave88-phase3-final.md:18, 72-94, 122, 189-192, 306` (F-4 finding + §1.5 stochasticity disclosure + cmd-line repro + Wave 83 "byte-stable" retraction)
- `/home/hugo/codes/flowa-multistep-reinference/docs/audit/wave91-phase5-final.md:92` (Wave 91 §5 decoder stochasticity note)
- `/home/hugo/codes/flowa-multistep-reinference/docs/audit/wave96e-final-synthesis.md:139-164` (honest std-target note template)
- `/home/hugo/codes/flowa-multistep-reinference/docs/audit/wave93-phase2-final.md` (per-cell Bonferroni table)
- `/home/hugo/codes/flowa-multistep-reinference/docs/audit/wave99b-n1000-verdict.md` (statistical power analysis)
- `/home/hugo/codes/flowa-multistep-reinference/docs/audit/wave87-phase3-sweep.md:155, 345` (Honest caveats #7 anchor)
- `/home/hugo/codes/flowa-multistep-reinference/docs/audit/wave87-phase4-final.md:370` (1 mol dropped — CTMC valence artifact)
- `/home/hugo/codes/flowa-multistep-reinference/docs/audit/wave106-a-2-audit.md:125-158` (Wave 106.A.2 F-02 disclosure)
- `/home/hugo/codes/flowa-multistep-reinference/docs/audit/wave106-a3-honesty-gaps.md:24-60` (30-finding honesty-gap audit table)
- `/home/hugo/codes/flowa-multistep-reinference/docs/audit/wave106-a4-path-consistency.md` (41-finding path + data consistency audit)
- `/home/hugo/codes/flowa-multistep-reinference/docs/audit/wave69-phase5-lineageflow-sweep.md:1-60` (Wave 69 3-shell-call template)
- `/home/hugo/codes/flowa-multistep-reinference/docs/audit/wave81-phase3-sweep.md` + `wave81-phase4-final.md` (Wave 81 N=2 per arm kill + honest disclosure)
- `/home/hugo/codes/flowa-multistep-reinference/docs/audit/wave82-phase3-sweep.md` + `wave82-phase4-final.md` (Wave 82 PB-xtb + N=1000 sweep)
- `/home/hugo/codes/flowa-multistep-reinference/docs/audit/wave86-phase3-sweep.md` (Wave 86 N=1000 framework-vs-baseline — actual +116% source)
- `/home/hugo/codes/flowa-multistep-reinference/docs/audit/wave99-n1000-final.md` (Wave 99.D Kanzi real N=1000 verdict)

### Wave 107 research outputs (synthesized)

- `/home/hugo/codes/flowa-multistep-reinference/docs/audit/wave107-a1-seeded-decoder.md` (4 REUSE opportunities — REUSE-1 0 LOC wins)
- `/home/hugo/codes/flowa-multistep-reinference/docs/audit/wave107-a2-flowmol3-drop.md` (5 REUSE opportunities — REUSE-1 0 LOC disclosure + REUSE-2 ~5 LOC JSON wrapper)
- `/home/hugo/codes/flowa-multistep-reinference/docs/audit/wave107-a3-lineageflow-n1000-gpu.md` (12 REUSE opportunities — REUSE-1 0 LOC 3-shell-call OR optional 30-LOC shell)
- `/home/hugo/codes/flowa-multistep-reinference/docs/audit/wave107-a4-paper-presentation.md` (11 REUSE opportunities — REUSE-1 ~23 LOC drop-in + REUSE-2 ~15 LOC honesty-gap remediation)

### Wave 106 parent audits (synthesized)

- `/home/hugo/codes/flowa-multistep-reinference/docs/audit/wave106-a-1-adapter-stubs.md` (29 issues — 3 HIGH + 12 MEDIUM + 14 LOW)
- `/home/hugo/codes/flowa-multistep-reinference/docs/audit/wave106-a-2-audit.md` (7 issues — 4 HIGH + 2 MEDIUM + 1 LOW)
- `/home/hugo/codes/flowa-multistep-reinference/docs/audit/wave106-a3-honesty-gaps.md` (30 issues — 6 HIGH + 7 MEDIUM + 5 LOW + 11 NONE + 1 UNVERIFIED)
- `/home/hugo/codes/flowa-multistep-reinference/docs/audit/wave106-a4-path-consistency.md` (41 issues — 6 HIGH + 14 MEDIUM + 19 LOW + 7 UNVERIFIED)
- `/home/hugo/codes/flowa-multistep-reinference/docs/audit/wave106-final-synthesis.md` (Wave 106.C.5 — 107 findings → 4 audit docs → 4 fix waves)
- `/home/hugo/codes/flowa-multistep-reinference/docs/audit/wave106-c2-fix-summary.md` (F-02 — Wave 106.A.2 F-02 fix: Disclose FlowMol3 baseline arm N=999)
...
```json
{
  ...
  "output_file": "/home/hugo/codes/flowa-multistep-reinference/docs/audit/wave108-implementation-plan.md",
  "input_research_docs": [
