...
TODO_BANNER: str = (
    "TODO: tools/run_sota_flowmol3_v2_adapter_experiment.py is a stub.\n"
...
def _parse_args(argv: list[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        prog="run_sota_flowmol3_v2_adapter_experiment",
        description=(
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "[run_sota_flowmol3_v2_adapter_experiment] parsed args:\n"
