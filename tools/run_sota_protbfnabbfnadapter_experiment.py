...
:class:`adaptive_reflow.adapters.protbfnabbfnadapter
...
``tests/test_adapters/test_protbfnabbfnadapter.py`` exercise the
...
from adaptive_reflow.adapters.protbfnabbfnadapter import (
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "tools/run_sota_protbfnabbfnadapter_experiment.py: STUB. "
